...
// App version storage utilities
export const getStoredAppVersion = async () => {
  try {
    const version = await AsyncStorage.getItem("storedAppVersion");
    return version;
  } catch (error) {
...
export const setStoredAppVersion = async (version) => {
  try {
    await AsyncStorage.setItem("storedAppVersion", version);
  } catch (error) {
