...
const Analysis = () => {
  ...
  const onSubmit = async (data) => {
    ...
    try {
      ...
      const { coordinates: coords } = geocodeResponse.data.location;
      
      // Store coordinates for Google Maps visualization
      setCoordinates({
        lat: coords.latitude,
                  ...
                  <div className="border-b border-gray-200">
                    <nav className="flex -mb-px" aria-label="Tabs">
                      ...
                      <button
                        ...
                        `}
                      >
                        <Satellite className="inline-block w-5 h-5 mr-2" />
                        Satellite View
                      </button>
                    </nav>
                  </div>
                  ...
                  <Card.Header>
                    <div className="flex items-center justify-between">
                      <div>
                        ...
                        <p className="text-sm text-gray-500 mt-1">
                          Google Maps satellite imagery for visualization only. This is reference imagery and is not used for analysis.
                        </p>
                      </div>
                    </div>
                  </Card.Header>
                    ...
                    {coordinates ? (
                      ...
                      <div className="flex items-center justify-center h-96 bg-gray-100 rounded-lg border-2 border-dashed border-gray-300">
                        <div className="text-center">
                          <Satellite className="mx-auto h-12 w-12 text-gray-400 mb-2" />
